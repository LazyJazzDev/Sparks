...
vec3 EvalPrincipledBSDF(in vec3 omega_in, out float pdf) {
  CalculateClosureWeight(
      material.base_color, material.subsurface_color, material.subsurface,
      material.subsurface_radius, material.metallic, material.specular,
      material.specular_tint, material.roughness, material.anisotropic,
      material.anisotropic_rotation, material.sheen, material.sheen_tint,
      material.clearcoat, material.clearcoat_roughness, material.ior,
      material.transmission, material.transmission_roughness);
  pdf = 0.0;
